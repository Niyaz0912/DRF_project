...
from sections.views import SectionListAPIView, SectionCreateAPIView, SectionRetrieveAPIView, SectionUpdateAPIView, \
    ...
    ContentDestroyAPIView, TestListAPIView, TestQuestionRetriveAPIView
...
urlpatterns = [
    ...
    path('tests/<int:pk>', TestQuestionRetriveAPIView.as_view(), name='test')
] + router.urls
